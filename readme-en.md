...
**Important**:
- When distributing this software or a modified version, comply with the source-code and other obligations of AGPL-3.0
- Use the software only with content you have the right to access, and follow applicable laws and service terms
- Third-party plugins and music sources are independent of this project; their providers and users remain responsible for their respective actions as required by law
